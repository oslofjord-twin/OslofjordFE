...
function DropdownItem ({name, itemId, setChosenSpecies, setDropdown, setSearchQuery}: DropdownItemProps) : ReactElement {
  return (
    <li id={name} onClick={() => {setChosenSpecies({item: name, id: itemId}); setDropdown(false); setSearchQuery(name);}} className='cursor-pointer'>
