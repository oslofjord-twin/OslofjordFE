...
function SensorInfoCard(props: SensorProps) {
  return (
    <div className='grid grid-rows-3 w-72 md:w-60 lg:w-72 h-36 bg-slate-100 text-slate-900 p-4 m-4 lg:m-8 rounded-lg'>
      ...
      <div className='mt-4 row-start-2 grid grid-cols-3'>   
        ...
        <div className='flex flex-row  place-content-end mt-1'> 
          <ArrowDropUpIcon fontSize="large" className="peer"/>
